...
class StepTypeTablet extends StatefulWidget {
  const StepTypeTablet({super.key});

  @override
  State<StepTypeTablet> createState() => _StepTypeTabletState();
}

class _StepTypeTabletState extends State<StepTypeTablet> {
  @override
