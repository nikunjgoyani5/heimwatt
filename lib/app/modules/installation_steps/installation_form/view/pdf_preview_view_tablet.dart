...
class PdfPreviewViewTablet extends StatelessWidget {
  const PdfPreviewViewTablet({super.key});
            ...
            Expanded(
              child: Container(
                ...
                /*FutureBuilder<Uint8List>(
                  future: loadPdfBytes(controller),
                  builder: (context, snapshot) {
                    ...
                    return SfPdfViewer.memory(snapshot.data!, key: pdfViewerKey);
                  },
                ),*/
              ),
            ),
  ...
  void _downloadPdf(InstallationStepsController controller) {
    if (kIsWeb) {
      final String pdfUrl = controller.pdfNetworkUrl ?? 'assets/pdf/demo_report.pdf';
