...
class EditImageDialog extends StatefulWidget {
  ...
  const EditImageDialog({super.key, required this.image, this.onSave, this.onCancel});
  ...
  @override
  State<EditImageDialog> createState() => _EditImageDialogState();
}

class _EditImageDialogContent extends StatefulWidget {
  final UploadedImage image;
  final Function(Uint8List)? onSave;
  final VoidCallback? onCancel;
  final BuildContext dialogContext;

  const _EditImageDialogContent({required this.image, this.onSave, this.onCancel, required this.dialogContext});

  @override
  State<_EditImageDialogContent> createState() => _EditImageDialogContentState();
}

class _EditImageDialogContentState extends State<_EditImageDialogContent> {
